 ...
 export const useBookStore = defineStore('book', {
   state: () => ({ 
    ...
    books: [
        ...
        { id: 21, status: 'tbr', collection: true, title: 'The Hedge Witch of Foxhall', author: 'Anna Bright', authGend: 'Female', authCoun: 'USA', age: 'YA', primGenr: 'Fantasy', secoGenr: '', pages: 389, publYear: 2024, publisher: 'HarperCollins', format: 'Hardback', dateStar: '', dateFini: '', rating: '', review: '' },

        { id: 22, status: 'tbr', collection: true, title: 'The Crimson Moth', author: 'Kristen Ciccarelli', authGend: 'Female', authCoun: 'Canada', age: 'YA', primGenr: 'Fantasy', secoGenr: '', pages: 404, publYear: 2024, publisher: 'HarperCollins', format: 'Hardback', dateStar: '', dateFini: '', rating: '', review: '' },
        ...
        { id: 28, status: 'tbr', collection: true, title: 'The Girl With No Reflection', author: 'Keshe Chow', authGend: 'Female', authCoun: 'Australia', age: 'YA', primGenr: 'Fantasy', secoGenr: 'Romance', pages: 483, publYear: 2024, publisher: 'HarperCollins', format: 'Hardback', dateStar: '', dateFini: '', rating: '', review: '' },

        { id: 29, status: 'reading', collection: true, title: 'The Burial of the Rats: And Other Tales of the Macabre by Bram Stoker', author: 'Bram Stoker', authGend: 'Male', authCoun: 'Ireland', age: 'Adult', primGenr: 'Horror', secoGenr: 'Gothic', pages: 239, publYear: 2023, publisher: 'The British Library', format: 'Hardback', dateStar: '2024-10-13', dateFini: '', rating: '', review: '' },

        { id: 30, status: 'reading', collection: false, title: 'Star Trek: Godshock', author: 'Jackson Lanzing, Collin Kelly', authGend: 'Multi Auth', authCoun: 'Multi Auth', age: 'Adult', primGenr: 'Sci-Fi', secoGenr: '', pages: 192, publYear: 2023, publisher: 'Idea & Design Works (IDW)', format: 'Graphic', dateStar: '2024-10-11', dateFini: '', rating: '', review: '' },

        { id: 31, status: 'tbr', collection: true, title: 'A Deadly Education', author: 'Naomi Novik', authGend: 'Female', authCoun: 'USA', age: 'YA', primGenr: 'Fantasy', secoGenr: '', pages: 320, publYear: 2020, publisher: 'Cornerstone', format: 'Paperback', dateStar: '', dateFini: '', rating: '', review: '' },

        { id: 32, status: 'read', collection: true, title: 'Graveyard Shift', author: 'M. L. Rio', authGend: 'Female', authCoun: 'USA', age: 'Adult', primGenr: 'Horror', secoGenr: 'Crime', pages: 110, publYear: 2024, publisher: 'Titan Books', format: 'Hardback', dateStar: '2024-10-13', dateFini: '2024-10-13', rating: 7, review: '' }
